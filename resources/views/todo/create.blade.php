                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('todo.store') }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" class="block w-full mt-1 rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500">{{ old('description') }}</textarea>
